...
class PoseFlowNet(BaseModel):
    ...
    def set_input(self, input):
        idx = random.randint(0,input['images'].size(1)-1)
        self.input_P1 = input['ref_image'].cuda()
        self.input_P2 = input['images'][:,idx,...].cuda()
        self.input_BP1 = input['ref_pose'].cuda()
        self.input_BP2 = input['poses'][:,idx,...].cuda()
